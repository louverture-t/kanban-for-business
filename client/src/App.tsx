...
function PriorityPage() {
  return <div className="p-8"><h1 className="text-2xl font-bold">Priority View</h1></div>;
}
...
function TeamPage() {
  return <div className="p-8"><h1 className="text-2xl font-bold">Team View</h1></div>;
}
