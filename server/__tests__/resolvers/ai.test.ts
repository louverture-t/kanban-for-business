...
import { aiResolvers, __resetAiRateLimiterForTests } from '@server/resolvers/aiResolvers.js';
...
afterEach(() => {
    // Clear the in-memory rate-limit buckets between tests to prevent cross-test pollution
